...
当前版本不包含微信开放平台深度能力、个性化短域名和 NFC。认证设计见 [账户与认证说明](docs/AUTHENTICATION.md)，租户模型见 [租户隔离与权限说明](docs/TENANCY_AND_PERMISSIONS.md)，名片设计见 [名片与模板说明](docs/CARDS_AND_TEMPLATES.md)，分享设计见 [H5 名片与分享说明](docs/H5_SHARING.md)，后续范围见 [版本迭代需求文档](docs/ITERATION_REQUIREMENTS.md)。
