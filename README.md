...
![Version](https://img.shields.io/badge/version-0.4.0-26734d.svg)
...
V0.4.0 已完成企业空间、权限和员工管理闭环，当前仓库包含：
...
当前版本不包含考勤、薪资、人事审批和数字名片业务。认证设计见 [账户与认证说明](docs/AUTHENTICATION.md)，租户模型见 [租户隔离与权限说明](docs/TENANCY_AND_PERMISSIONS.md)，员工设计见 [员工管理说明](docs/EMPLOYEE_MANAGEMENT.md)，后续范围见 [版本迭代需求文档](docs/ITERATION_REQUIREMENTS.md)。
...
- [ ] **V0.5.0～V1.0.0：数字名片 MVP** — 名片、分享、产品、线索与 CRM
