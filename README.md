...
![Version](https://img.shields.io/badge/version-0.5.0-26734d.svg)
...
V0.5.0 已完成企业名片模板、员工名片草稿和发布闭环，当前仓库包含：
...
当前版本不包含自由拖拽页面设计器、模板商城、NFC 写卡和完整 H5 分享闭环。认证设计见 [账户与认证说明](docs/AUTHENTICATION.md)，租户模型见 [租户隔离与权限说明](docs/TENANCY_AND_PERMISSIONS.md)，员工设计见 [员工管理说明](docs/EMPLOYEE_MANAGEMENT.md)，名片设计见 [名片与模板说明](docs/CARDS_AND_TEMPLATES.md)，后续范围见 [版本迭代需求文档](docs/ITERATION_REQUIREMENTS.md)。
...
- [ ] **V0.6.0～V1.0.0：数字名片 MVP** — 分享、产品、线索与 CRM
