...
![Version](https://img.shields.io/badge/version-0.9.0-26734d.svg)
...
V0.9.0 已完成从线索转客户、销售跟进到商机漏斗的基础 CRM 闭环，当前仓库包含：
...
当前版本不包含报价单、合同、回款、复杂销售预测、短信和企业微信通知、库存、价格促销、购物车及订单支付。认证设计见 [账户与认证说明](docs/AUTHENTICATION.md)，租户模型见 [租户隔离与权限说明](docs/TENANCY_AND_PERMISSIONS.md)，名片设计见 [名片与模板说明](docs/CARDS_AND_TEMPLATES.md)，产品设计见 [产品中心与素材库说明](docs/PRODUCTS_AND_MATERIALS.md)，线索设计见 [客户留资、线索分配与站内通知说明](docs/LEADS_AND_NOTIFICATIONS.md)，CRM 设计见 [客户档案、销售跟进与商机说明](docs/CUSTOMERS_AND_CRM.md)，后续范围见 [版本迭代需求文档](docs/ITERATION_REQUIREMENTS.md)。
...
- [ ] **V1.0.0：数字名片 MVP 稳定发布** — 初始化、备份、监控与发布保障
